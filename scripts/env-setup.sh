...
TEST_ACCOUNT=${{ secrets.SNOWFLAKE_TEST_ACCOUNT }}
TEST_PASSWORD=${{ secrets.SNOWFLAKE_TEST_PASSWORD }}
TEST_USER=${{ secrets.SNOWFLAKE_TEST_USER }}
TEST_WAREHOUSE=${{ secrets.SNOWFLAKE_TEST_WAREHOUSE }}
TEST_OAUTH_REFRESH_TOKEN=${{ secrets.SNOWFLAKE_TEST_OAUTH_REFRESH_TOKEN }}
TEST_OAUTH_CLIENT_ID=${{ secrets.SNOWFLAKE_TEST_OAUTH_CLIENT_ID }}
TEST_OAUTH_CLIENT_SECRET=${{ secrets.SNOWFLAKE_TEST_OAUTH_CLIENT_SECRET }}
TEST_ALT_DATABASE=${{ secrets.SNOWFLAKE_TEST_ALT_DATABASE }}
TEST_ALT_WAREHOUSE=${{ secrets.SNOWFLAKE_TEST_ALT_WAREHOUSE }}
TEST_DATABASE=${{ secrets.SNOWFLAKE_TEST_DATABASE }}
TEST_QUOTED_DATABASE=${{ secrets.SNOWFLAKE_TEST_QUOTED_DATABASE }}
TEST_ROLE=${{ secrets.SNOWFLAKE_TEST_ROLE }}
